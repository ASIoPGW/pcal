...
We developed the photo detector as shown in Fig.xxx. We employ the InGaAs photo diode for absolute power measurement. The InGaAs diode is placed on the circuit board. The beam is collimated for the power detection reasonably. We housed the circuit board into the aluminum case coated by the black anodized aluminum. 
...
\subsection{QPD}
We will implement QPDs for beam position control, which made by Tholabs.  They also help us to understand the alignment drifts of the beams. 
