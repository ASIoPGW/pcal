...
The laser is operated with the active power control (APC) mode and the active current control (ACC) mode.
...
The property of the beam is measured with the beam profiler. The beam profiler can measure the beam width with two axis, X axis and Y axis. We estimate the beam waist of X and Y axis as shown in Fig.~\ref{fig:w_z}. The estimated beam width is listed in Table.\ref{tab:beam_parameter}. Using the estimated value, we place the lens and make the focus point. %We measure the beam spot size around the focus point for understanding the beam quality. The estimated beam quality factor is listed in Table~\ref{beam_parameter}.
\begin{figure}
\begin{center}
...
%The specification of the beam shutter is shown in Table.~\ref{tab:Beam_shutter_spec}. 
We connect the laser shutter to interface chassis for controlling. %The pin assign of the shutter is listed in Fig.~\ref{fig:Shutter_pin}.
...
Edm                       =  1.74794e-08
NCalls                    =          227
p0                        =     0.829005   +/-   0.0109259   
p1                        =   -0.0703931   +/-   0.000560392 
p2                        =     0.837552   +/-   0.00881707  
p3                        =      -13.352   +/-   0.0311417   
\end{comment}
...
%----------------------------------------------------------------------------------------
\section{Periscope}
The periscope is used for sending the beams to the ETMX. We place the periscope in EXA chamber as shown in Fig.~\ref{fig:Periscope_overview}.
...
We employ eight 3 inch mirrors. We place the HR coating on the polished fused silica disc. The coating and polishing the fused silica is made by Sigma-koki corporation~\cite{Sigmakoki}. The reflectance of the mirror is shown in Fig.~\ref{fig:45_HR} and \ref{fig:225_HR}.
 ...
 \begin{table}
\caption{Specification of Mirrors in periscope in design value.}
...
Please refer the test procedure.
...
\section{Summary}
There is a need for future demonstration to better understanding how accurate measurement.
In particular, we should test the improved performance of high power laser, and  beam position monitoring system (BPM).
