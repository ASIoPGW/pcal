...
\midrule
L-Tx-1 &(CVI laser optics) & 25.4 & \\
L-Tx-2 &(CVI laser optics)  & 25.4& \\
L-Tx-3 &(CVI laser optics)  & 25.4 & \\
L-Tx-4 & (CVI laser optics) & 50.8 & \\
\bottomrule\\
\end{tabular}
\end{table}
...
\begin{table}
\caption{Typical gein parameter of OFS. }
\label{tab:OFS_Gain}
\centering
\begin{tabular}{ ccc}
\toprule
...
\caption{Circuit of photo detector designed by LIGO (D1300210).} 
...
We have simulated the deformation of window using ANSYS. The assumed Young's module, Poison ratio and density are listed in Table XXX. The deformation of the window center is $XXX~\mathrm{\mu m}$.
...
We employ eight 3 inch mirrors. We place the HR coating on the polished fused silica disc. The coating and polishing the fused silica is made by Sigma-koki corporation. The reflectance of the mirror is shown in Figure. XXXX.
 The reflectance of HR coating depends on the incident angle and the polarization angle. The specification of mirrors are summarized in Table.~\ref{tab:Periscope_mirror_spec}. All mirror is aligned with optical mirror mount made by XXXXXX.
 \begin{table}
...
M-P-1 &  &76.2  &50.0deg& \\
M-P-2 &  &76.2  &50.0deg& \\
M-P-u-3 &  &76.2   &26.3deg& \\
M-P-u4 &  &76.2   &42.9deg& \\
M-P-l-3 &  & 76.2  &26.5deg& \\
M-P-l-4 &  &76.2  &41.7deg& \\
M-P-u-5 &  &76.2   &26.5deg& \\
M-P-u6 &  &76.2   &41.7deg& \\
M-P-l-5 &  & 76.2  &26.3deg& \\
M-P-l-6 &  &76.2  &42.9deg& \\
M-P-7 &  &76.2  &50.0deg& \\
M-P-8 &  &76.2   &50.0deg& \\
...
\begin{figure}
\begin{center}
\includegraphics[width=8cm]{Figures/ML_focus.eps}
...
We also simulated the deformation of window surface using Ansys. The parameter of the simulation is listed in Table.XXX.
\begin{figure}
\begin{center}
\includegraphics[width=12cm]{Figures/Camera.eps}
\caption{Mirror and Telephoto camera(Tcam). We place the Tcam on the structure. The hight of the table is XXXX mm. The image of ETM is referred by two mirrors. One mirror is mounted in vacuums. Another is placed at outside of chamber. The specification of mirrors are listed in Table.XXX.} 
\label{fig:Camera} 
\end{center}
\end{figure}
 \begin{table}
...
\begin{tabular}{cccccc}
\toprule
\tabhead{Mirror number} & \tabhead{part number}& \tabhead{Size [mm]}   & \tabhead{Incident angle}& \tabhead{Polarization}  \\
\midrule
M-Tcam-1 &&  $\phi150$  &45deg& \\
M-Tcam-2 &&  $100 \times 80$  && \\
\bottomrule\\
\end{tabular}
\end{table}
...
\begin{figure}
\begin{center}
\includegraphics[width=8cm]{Figures/MEDM.eps}
\caption{.}
\label{fig:MEDM} 
\end{center}
\end{figure}
...
Overall, our optimized instrumental design make the essential role of systematic error understanding for KARA and other experiment.
